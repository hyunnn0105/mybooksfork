package com.project.mybooks.book.common.controller;

import com.project.mybooks.book.Util.FileUtils;
...
//    private static final String UPLOADPATH = "C:\\sl_test\\upload";
    // 업로드 파일 저장 경로
    // 파일 저장경로 집
    private static final String UPLOADPATH = "C:\\intellij\\imgsave";
